                        ...
                        {selected.map((option) => {
                            return (
                                <Badge
                                    key={option.value}
                                    className={cn(
                                        'rounded-full border border-gray-200 bg-white font-normal text-black shadow-none hover:bg-white data-[disabled]:bg-muted-foreground data-[disabled]:text-muted',
