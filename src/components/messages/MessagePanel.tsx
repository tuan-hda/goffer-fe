    ...
    return (
        <div className="relative h-screen">
            ...
            <div className="relative z-[1] flex h-full w-full flex-col bg-white/90 backdrop-blur-3xl">
                <div className="absolute top-0 z-[11] flex h-[66px] w-full items-center border-b bg-white/50 px-8 backdrop-blur-xl">
                    <p className="font-serif text-2xl font-bold">Robert Fox</p>
                </div>
                <MessageList />
                <div className="relative mb-[1px] flex h-[72px] min-h-[72px] w-full items-center border-t bg-white">
                    <Input
                        placeholder="Write your reply here..."
                        className="h-full w-full rounded-none border-0 pl-8 pr-24 tracking-wide"
                    />
