        ...
        <div>
          ...
          <div className="my-6 py-4 md:flex md:flex-row border-b-[0.5px] border-text">
            <div className="md:flex flex-row gap-4 flex-1 items-center">
              <p className="py-3 md:py-0 text-sm uppercase md:capitalize">
                {"Follow Us"}
              </p>
              <ul className="flex flex-row gap-2">
                {follows.map(({ Icon, href }, index) => (
                  <a
                    href={href}
                    key={index}
                    className="h-10 w-10 flex rounded-full border border-text hover:bg-[#d1cfcd]"
                  >
          ...
          <p className="flex-1 text-center text-xs">
            &copy; 2015-2024 Goffer Global Inc.
          </p>
        </div>
      </div>
    </div>
